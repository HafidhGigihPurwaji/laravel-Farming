...
class HitungController extends Controller
{
    ...
    public function hitung(Request $request){
        ...
        $minC3 = Alternatif::min('kuantitas');
        $maxC3 = Alternatif::max('kuantitas');
        $minC4 = Alternatif::min('keberlanjutanlingkungan');
        $maxC4 = Alternatif::max('keberlanjutanlingkungan');
        $minC5 = Alternatif::min('jangkauanlayanan');
        $maxC5 = Alternatif::max('jangkauanlayanan');
