              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Kualitas</th>
                    <th>Kuantitas</th>
                    <th>Keberlanjutan Lingkungan</th>
                    <th>Jangkauan Layanan</th>
                    <th>Aksi</th>
                  </tr>
                  </thead>
                  <tbody>
                @foreach($users as $i => $alternatif)
                  <tr>
                    ...
                    <td>{{ $alternatif->kuantitas }}</td>
                    <td>{{ $alternatif->keberlanjutanlingkungan }}</td>
                    <td>{{ $alternatif->jangkauanlayanan }}</td>
                    <td>
