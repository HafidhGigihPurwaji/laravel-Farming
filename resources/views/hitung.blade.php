              ...
              <div class="card-body">
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        <td>{{$alternatif->kuantitas / $C3max['alternatif']}}</td>
                        <td>{{$alternatif->keberlanjutanlingkungan / $C4max['alternatif']}}</td>
                        <td>{{$alternatif->jangkauanlayanan / $C5max['alternatif']}}</td>
                    </tr>
                @endforeach
                </tbody>
                </table>
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        <td>
                            ...
                            (($alternatif->kuantitas / $C3max['alternatif'])*$widget3['kriteria'])+
                            (($alternatif->keberlanjutanlingkungan / $C4max['alternatif'])*$widget4['kriteria'])+
                            (($alternatif->jangkauanlayanan / $C5max['alternatif'])*$widget5['kriteria'])}}
                        </td>
                    </tr>
                @endforeach
                </tbody>
